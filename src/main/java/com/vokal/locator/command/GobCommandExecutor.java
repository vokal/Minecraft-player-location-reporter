...
public class GobCommandExecutor implements CommandExecutor {
	...
	public GobCommandExecutor(PlayerLocator aPlugin) {
		mPlugin = aPlugin;
	}
	...
	public boolean onCommand(CommandSender aSender, Command aCmd, String aLabel, String[] aArgs) {
		...
		mPlugin.getServer().broadcastMessage(ChatColor.GREEN + "penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus penus");
